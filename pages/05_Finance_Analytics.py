...
# Fix: Duplicate semester columns renaming logic
...
BG  = 'rgba(0,0,0,0)'
GRD = dict(gridcolor='#e2e8f0', zerolinecolor='#e2e8f0') # Light grid lines
TXT = '#475569' # Darker text color
...
with c6:
    ...
    # Fix: Reversing logic wrapped inside yaxis layout safely
    fig6.update_layout(**LAY, height=340,
                       xaxis=dict(range=[0,4.8], title='CGPA', **GRD),
                       yaxis=dict(title='', autorange="reversed", **GRD))
